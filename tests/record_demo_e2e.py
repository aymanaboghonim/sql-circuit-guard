"""Record a complete end-to-end demo video of the Gradio app running multiple examples."""
...
def run_server():
    app = create_ui()
    app.launch(server_name="127.0.0.1", server_port=7863, quiet=True)
...
def record_demo():
    ...
    with sync_playwright() as p:
        ...
        page.goto("http://127.0.0.1:7863")
        page.wait_for_selector("text=SQL-Circuit-Guard", timeout=15000)
        time.sleep(2)

        # Example 1: Type natural language query
        ...
        # Example 2: Click Quick Click Example button 2 (Top 10 invoices)
        ...
        # Example 3: Click Quick Click Example button 3 (Count tracks per genre)
